-- Demo/sample data for IUEA Today Community module
-- Run: /opt/lampp/bin/mysql -u root iuea_today < backend/migrate_commission_demo.sql
-- Requires community_items table (see migrate_commission_to_community.sql on upgraded DBs)

USE iuea_today;

-- Community News (2 items)
INSERT INTO community_items (title, description, image, likes, comments_count, type, author_id, status, created_at) VALUES
(
  'Community Launches Annual Governance Review',
  'The IUEA Community has opened its annual governance review cycle, inviting faculty, students, and alumni to submit feedback on institutional policies and academic standards.',
  NULL,
  12,
  0,
  'news',
...
(
  ...
  'A digital portal giving the IUEA community access to community meeting minutes, policy drafts, and public consultation windows.',
  NULL,
  5,
  0,
  'initiative',
...
(
  ...
  'Summary of community activities, policy decisions, and stakeholder engagement outcomes for the 2025 academic year.',
  NULL,
  0,
  0,
  'report',
