...
USER_ROLE_LABELS = {
    ...
    "marketing_admin": "Marketing Admins",
...
def update_user_role(user_id: int, data: schemas.UserRoleUpdate, db: Session = Depends(get_db), current_user: User = Depends(require_super_admin)):
    ...
    valid_roles = ["public_visitor", "registered_user", "donor_partner", "content_editor", "coordinator", "innovation_admin", "marketing_admin", "super_admin"]
